...
public class EditTeman extends AppCompatActivity {
    ...
    public void EditData(){
        ...
        RequestQueue resuestQueue = Volley.newRequestQueue(getApplicationContext());
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url_update, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        Toast.makeText(EditTeman.this, "data SUCCESS diedit", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(EditTeman.this, "data GAGAL diedit", Toast.LENGTH_LONG).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditTeman.this,"Gagal Edit data", Toast.LENGTH_LONG).show();
            }
        }){
            @Override
